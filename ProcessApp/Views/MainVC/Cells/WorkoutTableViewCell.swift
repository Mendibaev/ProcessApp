...
class WorkoutViewCell: UITableViewCell {
  ...
  private func setConstraints() {
    ...
    NSLayoutConstraint.activate([
      ...
      workoutImageView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10),
    ...
    NSLayoutConstraint.activate([
      ...
      startButton.leadingAnchor.constraint(equalTo: workoutImageView.trailingAnchor, constant: 10),
